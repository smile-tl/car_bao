...
public class TitleView {
	...
	private TextView textView_left, textView_mid, textView_right ,textView_right_single;
	...
	public TitleView(Activity activity) {
		...
		textView_right_single = (TextView) activity
				.findViewById(R.id.textview_title_right_single);
	}

	public TextView getTextView_right_single() {
		return textView_right_single;
	}

	public void setTextView_right_single(TextView textView_right_single) {
		this.textView_right_single = textView_right_single;
	}
	...
	public TextView RightTextViewSingle(String msg,int background){
		if(textView_right_single!=null){
			textView_right_single.setText(msg);
			textView_right_single.setVisibility(View.VISIBLE);
			if(background != 0){
				textView_right_single.setBackgroundResource(background);
			}
		}
		return textView_right_single;
	}
